...
namespace NHaml.Tests.IO
{
    ...
    class HamlRuleFactory_Tests
    {
        ...
        [TestCase(".className", HamlRuleEnum.ViewProperty, Description = "Plain tag")]
        //[TestCase("#id", HamlRuleEnum.DivId, Description = "Plain tag")]
        [TestCase("%Tag", HamlRuleEnum.Tag, Description = "Plain tag")]
        [TestCase("/Tag", HamlRuleEnum.XmlComment, Description = "HTML Comment")]
        ...
        [TestCase(".className", ".className", Description = "Property of view object")]
